<template>
    ...
    <el-menu-item v-if="itemData.type == 2" :index="itemData.path">
        <el-icon><svg-icon :icon="itemData.icon"></svg-icon></el-icon>
        <span>{{ itemData.title }}</span>
    </el-menu-item>
    <el-sub-menu v-else-if="itemData.type == 1" :index="itemData.path">
        <template #title>
            <el-icon><svg-icon :icon="itemData.icon"></svg-icon></el-icon>
            <span>{{ itemData.title }}</span>
        </template>
